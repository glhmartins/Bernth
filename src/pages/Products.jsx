        ...
        <div className={style.products}>
            ...
            <div className={style.sweepProduct}>
                ...
                <div className={style.sweepText}>
                    <h1>Sweep Picking Masterclass</h1>
                    <h3>Sweep Picking Masterclass is a 10 week online course and consists of:</h3>
                    <p>40 in-depth instructional videos (2,5h runtime)<br/>
                    ...
                    <sub>
                        ** (The course videos can only be watched on the Sweep Picking Masterclass website. Videos cannot be downloaded for offline access.<br/>
                        ...
                        <br/>
                        <Link to="/Terms-And-Service">Read about the terms of service</Link><br/>
                    </sub>
            ...
            <div className={style.stepProduct}>
                ...
                <div className={style.stepText}>
                    <h1>10 Steps to Modern Shredding</h1>
                    <h3>10 Steps to Modern Shredding is a 10 week online course and consists of:</h3>
                    <p>
